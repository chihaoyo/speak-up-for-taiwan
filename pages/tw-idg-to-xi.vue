...
<i18n>
{
  ...
  "en": {
    ...
    "6-2": "Omi Wilang 歐蜜･偉浪 (Atayal), 王商益 Kaisanan Ahuan (Taokas), 乃俊廷 (Babuza), 張麗盆 (Papora), 潘明燈 (Papora), 巫瑞晞 (Arikun), 胡雋婕Snglang (Lloa), 潘隆川 (Kaxabu), 希婻･瑪飛洑 (Tao/Yami)"
  }
}
</i18n>
<template>
<div class="page indigenous-peoples-to-xi">
  <div>
