...
<i18n>
{
  "tw": {
    ...
    "1-2": "我們是台灣原住民族，生存在台灣這片母親土地上超過六千年，不是中華民族中的少數民族。我們祖先在台灣玉山、阿里山、大霸尖山、大武山、卑南主山、都蘭山以及山林、草原、深谷、溪流、島嶼、海洋流傳的故事明白顯示：台灣是原住民族的傳統領域，也是原住民族世世代代用生命守護的祖靈土地，不是中國的領土。",
    "1-3": "台灣原住民族見證著來到島嶼的西班牙人、荷蘭人、鄭氏王朝、清帝國、日本國、中華民國的言行，我們跟荷蘭人簽過契約、跟美國人簽過和平協議，對抗過每一個侵略我們土地的外來民族與帝國主義，也受到後來殖民國家的武力鎮壓、威權統治，從被稱番人到台灣原來的主人，原住民族更推動著國家走上人權、民主、自由的轉變歷程。千百年來，我們仍在這裡，從未放棄我們的自然主權。",
    "2-1": "## 習近平先生，你不懂尊嚴，因此誤會了偉大。",
    "2-2": "在我們母親土地上建立起來的主權國家台灣，我們並不滿意，因為原住民族的歷史正義與轉型正義才剛剛開始被這個國家重視，台灣島上的多元民族、多元文化、多元歷史觀才剛剛開始受到這個國家肯定。但，這也是我們與所有認同台灣土地的其他族群努力形塑的國家，是不同族群正在理解彼此痛苦經歷的國家，是我們可以大聲用自己語言說自己故事的國家。我們在母親土地上自己決定想要什麼樣的國家，並積極改造它，這是尊嚴。無論人口數是三百多人的卡那卡那富族，還是二十一萬多人的阿美族，我們每一個原住民族都有平等的自決權，這是尊嚴。",
    "2-3": "習近平先生代表中國政府所推銷的單一文化價值、統一、強權，並不偉大也不令人嚮往。對土地謙卑、尊重其他生命、與各族群共存共好，才是我們的信念。",
    "3-1": "## 習近平先生，人不應該傷害別人，無論這個人跟自己多麼不一樣。",
    "3-2": "習先生代表中國政府的談話，強調以武力為後盾，堅持統一台灣、實施一國兩制，並表示不會傷害同為中國人的人。但暴力是不對的，無論是不是中國人，都不應該遭到傷害。我們已經看到藏族、維吾爾族成為「中國人」之後，在「民族自治區」遭遇文化、語言、信仰的滅絕。我們看到一國兩制之下的香港人民，快速失去民主與自由。我們看到中國人民，甚至無法說出或捍衛自己的基本人權。",
    "3-3": "習先生，暴力無法帶來和平，Misawacu hanizaay masasu takid（欺侮別人的人也會受到同樣的報應；撒奇萊雅族古諺）。請帶領你的國家邁向真正的文明，停止武力恫嚇台灣人民，致力讓中國人民享有人權與自由。",
    "4-1": "## 習近平先生，台灣原住民族與台灣的主體性，拒絕威脅也不退讓。",
    "4-2": "台灣的國家未來，是母親土地上所有族群的自主決定，包括台灣原住民族在內。同時，沒有經過原住民族行使集體自決權之前，任何政府、政黨、團體都不得與外來勢力及國家協商，將原住民族的傳統領域併入他國領土或成為他國實質管理的範圍。這是我們守護母親土地的決心，台灣原住民族堅持了數千年，也會繼續堅持下去。",
    "4-3": "如果有一天，中國放棄扭曲的歷史觀、民族觀、國家觀，樂意成為我們的善良鄰居，而不是強行要當我們的父母。那個時候，我們會誠心舉杯，敬中國這個鄰居一杯小米酒。pasola xmnx na mansonsou!（願您每回呼吸都順暢；鄒族語）",
    "5-1": "### 聲明人",
  ...
  "ja": {
    ...
    "1-2": "私たちは台湾の原住民族で、6000年以上ものあいだ台湾という母なる地で生き抜いてきました。中華民族の中の少数民族ではありません。私たちの祖先が台湾の玉山、阿里山、大霸尖山、大武山、卑南主山、都蘭山及びその山林、草原、渓谷、溪流、島嶼、海洋に伝えてきた物語は、台湾が原住民族の伝統領域であり、原住民族が先祖代々その生命で守ってきた祖霊の土地であるということをはっきりと示しております。したがって中国の領土ではありません。",
    "1-3": "台湾原住民族は、この島にやって来たスペイン人、オランダ人、鄭王朝、清帝国、日本国、中華民国の言行を目撃してきました。私たちはオランダ人と契約を結び、アメリカ人と和平協定を結びました。私たちの土地を侵略したどの外来民族及びその帝国主義とも闘い、その後の植民地支配の武力鎮圧や独裁統治の支配を受けました。蕃人と呼ばれていた私たちが、台湾の本来の主人になるまでに、原住民族が国家を人権、民主主義、自由へとさらに推進させていく転換の歴史がありました。数百年来、私たちはなおこの地において、原住民族の自然主権をけっしてあきらめたことはありません。",
    "2-1": "## 習近平さま、あなたは尊厳を理解していません。だからあなたは偉大さというものを誤解しています。",
    "2-2": "自らの母なる地の上に成立している主権国家である台湾に対して、私たちはけっして満足しているわけではありません。なぜなら、原住民族の歴史的正義と移行期正義がようやくこの国家によって重視されるようになったばかりで、台湾島における多元的な民族、多元的な文化、多元的な歴史観も、ようやくこの国家によって認められるようになったばかりだからです。しかし、この国家は、私たちと同じく台湾という地にアイデンティティを持っているその他の族群（エスニックグループ）と私たちが一生懸命に形作ってきた国家でもあり、異なる族群が互いの痛ましい歴史を今まさに理解しようとしている国家であり、私たちが堂々と自身の言語で自分の物語を話すことができる国家なのです。私たちは自らの母なる地にどのような国家を望むかを決め、それを積極的に変革しています。 これが尊厳です。たとえそれは人口300人余りのカナカナブ族であれ、または21万人以上のアミ族であれ、私たち原住民族はそれぞれが平等な自決権を有しております。これが尊厳なのです。",
    "2-3": "習近平さまが中国政府を代表して売り捌こうとしているのは、単一の文化的価値、統一、そして強権ですが、これらはけっして偉大なものでも、望ましいものでもありません。この地に謙虚に向き合い、すべての生命を尊重し、そして各族群と共存共栄すること、これこそ私たちの信念です。",
    "3-1": "## 習近平さま、人は他者を傷つけるべきではありません。たとえその人がどんなに自分と違っていたとしても。",
    "3-2": "習さまが中国政府を代表して発表した談話は、武力を後ろ盾に台湾統一と一国二制度の実施を堅持する旨を強調する内容であり、同じ中国人であれば傷つけることはないという表明でした。しかし、暴力は間違っています。中国人であろうとなかろうと、誰かに傷つけられるべきではありません。私たちはすでにチベット族やウイグル族が「中国人」となった後に「民族自治区」において文化、言語、信仰の殲滅に遭っている状況を、一国二制度下の香港人民が民主主義と自由を急速に失いつつある状況を、中国人民が自らの基本的人権を守ることも口にすることさえもできない状況を、目の当たりにしています。",
    "3-3": "習さま、暴力は平和をもたらしません。Misawacu hanizaay masasu takid（「他者を虐める者は、自らも同様の報いを受ける」という意味のサキザヤ族の諺）。どうか、あなたの国家を本当の文明へと導いてください。武力によって台湾人民を恫喝するのをやめ、中国人民に人権と自由を享受させるよう取り組んでください。",
    "4-1": "## 習近平さま、台湾原住民族と台湾の主体性は、威嚇を拒絶し、譲歩もしません。",
    "4-2": "台湾の国家の未来は、母なる地の上に存在するあらゆる族群が自主的に決定するものであり、それには台湾原住民族も含まれています。同時に、原住民族による集団自決権の行使を経ること無しに、いかなる政府、政党、団体も、外来勢力及び国家と協議したり、原住民族の伝統領域を他国の領土もしくは他国が実質的に管理する範囲に併合したりすることはできません。これは私たちが母なる地を守る決意であり、台湾原住民族が数千年にわたって堅持してきた信念であり、これからも堅持し続けていものです。",
